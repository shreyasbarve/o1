...
<footer class="page-footer middleColor  font-small unique-color-dark">
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
        ...
        <h6 class="text-uppercase white font-weight-bold">O(1) Coding Club</h6>
        <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" />
        <p className="white">We've got a strong team filled with caffeine addicted developers, gradient loving designers and machine like working managers providing a solution for Great Coding</p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <p className="white">
          <i class="fa fa-envelope white mr-3"></i> O(1)codingclub@gmail.com</p>
        <p className="white">
  ...
  <div class="footer-copyright text-center py-3 copyrightColor">© 2020 :
    <a href="https://mdbootstrap.com/"> O(1) Coding Club</a>
  </div>
